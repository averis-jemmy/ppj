...
public class CalendarPickerDialog extends AlertDialog implements android.view.View.OnClickListener
{
	...
	public CalendarPickerDialog(Context context, int theme)
	{
		super(context, theme);
		// TODO Auto-generated constructor stub
	}

	protected CalendarPickerDialog(Context context, boolean cancelable, OnCancelListener cancelListener)
	{
	...
	public CalendarPickerDialog(Context context, int selectedyear, int selectedmonth, int selectedday)
	{
		super(context);

...
public class CustomSpinnerAdapter  implements SpinnerAdapter, ListAdapter
{
	...
	public <T> CustomSpinnerAdapter(ArrayList<T> data, int emptyBox)
	{
		if(emptyBox == 1)
			m_data.add(new BaseEntity("", "Pilih"));
	...
	public CustomSpinnerAdapter(ArrayList<BaseEntity> data, boolean isCodeDisplay)
	{
		m_data = data;
		codeDisplay = isCodeDisplay;
	}

	public CustomSpinnerAdapter(ArrayList<BaseEntity> arrayList, String abc)
	{
		m_data = arrayList;
	}	

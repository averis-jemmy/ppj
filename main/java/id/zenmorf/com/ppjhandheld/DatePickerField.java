...
public class DatePickerField extends TextView
{
	public DatePickerField(Context context, AttributeSet attrs, int defStyle)
	{
	...
	private void init()
	{
		this.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v)
			{
				...
				if(v.isEnabled())
				{
					CalendarPickerDialog obj = new CalendarPickerDialog(getContext(), mYear, mMonth, mDay);
					obj.setOnDismissListener(new OnDismissListener() {
						...
						{
							// TODO Auto-generated method stub
							CalendarPickerDialog obj = (CalendarPickerDialog) dialog;
	...
	private CustomDatePickerDialog.OnDateSetListener mDateSetListener =

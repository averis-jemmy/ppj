...
public class DBKLSpinner extends Spinner
{

	private AlertDialog mPopup;

	public DBKLSpinner(Context context)
	{
		super(context);
	}

	public DBKLSpinner(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}

	public DBKLSpinner(Context context, AttributeSet attrs, int defStyle)
	{

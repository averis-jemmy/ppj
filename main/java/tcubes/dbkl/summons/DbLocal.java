...
/*	public static List<DBKLOffences>GetListForOffenceActSpinner(Context context, String offenceActShortDesc)
	{
		List<DBKLOffences> list = new ArrayList<DBKLOffences>();
		DbUtils obj = new DbUtils(context);
		obj.Open();
		...
		if( (cur != null) && cur.moveToFirst() )
		{
			...
			do
			{		
				DBKLOffences category = new DBKLOffences(
						cur.getString(DBKLOffences.ColumnName.CODE.ordinal()),
						cur.getString(DBKLOffences.ColumnName.DESCRIPTION.ordinal()),
						cur.getString(DBKLOffences.ColumnName.NO.ordinal()),
						cur.getString(DBKLOffences.ColumnName.SUBSECTION_NO.ordinal())						
						);
				list.add(category);
            } while (cur.moveToNext());
			cur.close();
	...
	*/
	public static int DoLogin(String userId, String password,Context context)
	{
		...
		ArrayList<DBKLOfficerInfo> list = new ArrayList<DBKLOfficerInfo>();
		list.clear();
		...
		if( (cur != null) && cur.moveToFirst() )
		{
			...
			do
			{
				DBKLOfficerInfo category = new DBKLOfficerInfo(
						cur.getString(DBKLOfficerInfo.ColumnName.CODE.ordinal()),
						cur.getString(DBKLOfficerInfo.ColumnName.ID.ordinal()),
						cur.getString(DBKLOfficerInfo.ColumnName.RANK.ordinal()),
						cur.getString(DBKLOfficerInfo.ColumnName.RANKNO.ordinal()),
						cur.getString(DBKLOfficerInfo.ColumnName.NAME.ordinal()),
						cur.getString(DBKLOfficerInfo.ColumnName.PASSWORD.ordinal())
						);

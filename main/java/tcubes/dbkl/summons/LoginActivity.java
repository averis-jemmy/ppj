...
public class LoginActivity extends Activity {
	...
	private boolean ProcessLogin()
	{
		...
		if( bResult == 0)
		{
			DBKLAlertDialog.Show(LoginActivity.this,"LOGIN", "Login Gagal. Rekod ID " + txtUserName.getText().toString() + " Tidak Wujud.", 3);
		}
		else if(bResult == 1)
		{
			DBKLAlertDialog.Show(LoginActivity.this,"LOGIN", "Login Gagal. Password Tidak Betul.", 3);
		}
		else if(bResult == 2)
		{
			login = true;
	...
	private boolean ValidateLogin()
	{
		...
		{
			DBKLAlertDialog.Show(LoginActivity.this,"LOGIN", "Sila Masukkan ID Pegawai", 3);
			return false;
		}
		txtPassword = (EditText)findViewById(R.id.etPassword);
		if(txtPassword.getText().toString().isEmpty())
		{
			DBKLAlertDialog.Show(LoginActivity.this,"LOGIN", "Sila Masukkan Password", 3);
			return false;
		}
		spinnerZone = (Spinner) findViewById(R.id.spinnerZone);
		if(spinnerZone.getSelectedItemPosition() <= 0)
		{
			DBKLAlertDialog.Show(LoginActivity.this,"LOGIN", "Sila Pilih Bhg/Zon/Unit", 3);
			return false;
		}
